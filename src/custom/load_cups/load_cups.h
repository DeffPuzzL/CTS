...
public:
	...
	long    	lCntp_CheckCupsFee(TCupsSucc *pstCupTxn, dbMchtCupsInf *pstCupsInf);
	long    	lCpnr_CheckCupsFee(TCupsSucc *pstCupTxn, dbMchtCupsInf *pstCupsInf);
	long    	lHxnp_CheckCupsFee(TCupsSucc *pstCupTxn, dbMchtCupsInf *pstCupsInf);
	long    	lCheckCupsFee(TCupsSucc *pstCups, dbMchtCupsInf *pstCupsInf);
